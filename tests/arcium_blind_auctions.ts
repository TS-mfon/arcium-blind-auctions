...
import { ArciumBlindAuctions } from "../target/types/arcium_blind_auctions";
...
describe("ArciumBlindAuctions", () => {
  // Configure the client to use the local cluster.
  anchor.setProvider(anchor.AnchorProvider.env());
  const program = anchor.workspace
    .ArciumBlindAuctions as Program<ArciumBlindAuctions>;
  ...
  async function initAddTogetherCompDef(
    program: Program<ArciumBlindAuctions>,
